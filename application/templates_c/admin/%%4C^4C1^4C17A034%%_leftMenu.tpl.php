<?php /* Smarty version 2.6.27, created on 2016-06-08 06:01:33 compiled from _leftMenu.tpl */ ?>
...
</a></span><p><a class="ext" href="/admin/logout/"><i class="icon-off"></i> Выход</a></p></div></li> <li><div><a href="/admin/settings/"><img src="<?php echo $this->_tpl_vars['THEME']; ?>
/img/ic1.png"></a> <span><a href="/admin/settings/">Настройки сайта</a></span><p>Различные настройки сайта</p></div></li> <li><div><a href="/admin/patterns/"><img src="<?php echo $this->_tpl_vars['THEME']; ?>
/img/ic1.png"></a> <span><a href="/admin/patterns/">Шаблоны</a></span><p>Список шаблонов</p></div></li> <li><div><a href="/admin/patterns_dirs/"><img src="<?php echo $this->_tpl_vars['THEME']; ?>
/img/ic1.png"></a> <span><a href="/admin/patterns_dirs/">Директории шаблонов</a></span><p>Список директорий шаблонов</p></div></li> <li><div><a href="/admin/music_files/"><img src="<?php echo $this->_tpl_vars['THEME']; ?>
/img/ic2.png"></a> <span><a href="/admin/music_files/">Музыкальные файлы</a></span><p>Список музыкальных файлов</p></div></li> <li><div><a href="/admin/adverts/"><img src="<?php echo $this->_tpl_vars['THEME']; ?>
