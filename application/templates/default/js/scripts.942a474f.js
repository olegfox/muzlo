...
angular.module("muzloTemplateApp").factory("AudioService", function () {
    ...
    var a = function (b, c) {
        function d(b, c) {
            ...
            function i(a) {
                ...
                }), j.addClass("slider-ready"), k = $(p + "rotater", j), t.scrollRotation && j.on("mousewheel DOMMouseScroll", g)
            }
    ...
    this.awesomeThings = ["HTML5 Boilerplate", "AngularJS", "Karma"], jQuery(".slider3d__item").each(function (a, b) {
        ...
        $(b).data("current-level") && $(b).click(function (a) {
            console.log($(b).data("current-level")), a.preventDefault(), rotatingSlider.navigateDown()
        })
